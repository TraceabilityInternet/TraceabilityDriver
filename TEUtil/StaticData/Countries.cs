...
namespace TraceabilityEngine.Util.StaticData
{
    public static class Countries
    {
        ...
        {
            string data = null;
            data = TEStaticData.ReadData("Countries.xml");
            TEXML xmlCountries = new TEXML();
            xmlCountries.LoadFromString(data);
            foreach (TEXML xmlCountry in xmlCountries)
            {
    ...
    public class Country : IEquatable<Country>, IComparable<Country>
    {
        ...
        public Country(TEXML xmlCountry)
        {
        ...
        public TEXML ToXML(TEXML xmlParent, string name = "Country")
        {
            TEXML xmlCountry = xmlParent.AddChild(name);
        ...
        public static Country FromXML(TEXML xmlCountry)
        {
            Country country = new Country(xmlCountry);
            return (country);
