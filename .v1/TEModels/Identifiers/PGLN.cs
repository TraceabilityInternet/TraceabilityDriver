...
namespace TraceabilityEngine.Models.Identifiers
{
    ...
    /// </summary>
    [DataContract]
    public class PGLN : IEquatable<PGLN>, IComparable<PGLN>, IPGLN
    {
        ...
        public PGLN(string pglnStr)
        {
            ...
            {
                throw new TEException($"The PGLN {pglnStr} is not valid. {error}");
            }
        ...
        public static string DetectPGLNIssue(string pglnStr)
        {
            try
            {
                ...
                else if (pglnStr.Length == 13 && pglnStr.IsOnlyDigits())
                {
                    ...
                    char checksum = GS1.CalculateGLN13CheckSum(pglnStr);
        ...
        public static bool TryParse(string pglnStr, out IPGLN pgln, out string error)
        {
            try
            {
