...
{
    public interface ITEProductNutrition
    {
        ...
        public ITEProductNutritionCalorieMeasurement EnergyCalories { get; set; }

        [DisplayName("Kilo-Joules")]
        public ITEProductNutritionJoulesMeasurement EnergyJoules { get; set; }

        [DisplayName("Kilo-Calories from Fat")]
        public ITEProductNutritionCalorieMeasurement EnergyFromFatCalories { get; set; }

        [DisplayName("Kilo-Joules from Fat")]
        public ITEProductNutritionJoulesMeasurement EnergyFromFatJoules { get; set; }
    ...
    public class NutrientDefaultUnitAttribute : System.Attribute
    {
        public string Unit { get; set; }

        public NutrientDefaultUnitAttribute(string unit)
        {
            this.Unit = unit;
        }
    }
