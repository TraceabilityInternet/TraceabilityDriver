...
namespace TraceabilityEngine.Util.StaticData
{
    ...
    public static class UOMS
    {
        ...
        static public UOM GetUOMFromID(int ID)
        {
            ...
            if (uom == null)
            {
                TELogger.Log(0, "Failed to locate UoM by legacyID=" + ID);
            }
            return (uom);
        }
    ...
    public partial class UOM
    {
        ...
        public static UOM ParseFromName(string name)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        TELogger.Log(1, "Unit conversion failed, Name=" + name);
                    }
                }
            }
            catch (Exception ex)
        ...
        public Int64 TRITEetter
        {
            ...
            set
            {
                ...
                {
                    string Message = ex.Message;
                    TELogger.Log(1, "Unit conversion failed, ID=" + value);
                }
            }
        ...
        public TEXML ToXML(TEXML xmlParent, string name = "UOM")
        {
            TEXML xmlUOM = xmlParent.AddChild(name);
        ...
        public static UOM FromXML(TEXML xmlUOM)
        {
            UOM uom = new UOM();
